import { BuyerRepository } from "~/server/repositories/pt-pks/buyer.repo";
import { BuyerMapper } from "~/server/mappers/pt-pks/buyer.mapper";
...
} from "~/server/types/pt-pks/buyer";
