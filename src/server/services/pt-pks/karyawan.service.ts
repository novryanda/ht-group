...
import { KaryawanRepository } from "~/server/repositories/pt-pks/karyawan.repo";
import {
  ...
  static async getEmployeeList(
    ...
    try {
      ...
      const items: EmployeeListItemDTO[] = result.items.map((emp) => ({
        ...
        divisiName: emp.divisi?.name ?? null,
        jabatanId: emp.jabatanId,
        jabatanName: emp.jabatan?.name ?? null,
  ...
  static async getEmployeeDetail(
    ...
    try {
      ...
      const employeeDTO: EmployeeDTO = {
        ...
        divisiName: employee.divisi?.name ?? null,
        jabatanId: employee.jabatanId,
        jabatanName: employee.jabatan?.name ?? null,
