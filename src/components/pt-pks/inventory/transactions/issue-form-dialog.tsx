...
export function IssueFormDialog({ open, onClose }: IssueFormDialogProps) {
  ...
  const form = useForm<IssueFormData>({
    ...
    defaultValues: {
      ...
      purpose: "",
      note: "",
      items: [{ materialId: "", locationId: "", qty: 0, uomId: "", note: "" }],
    },
  });
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Buat Goods Issue</DialogTitle>
        </DialogHeader>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} placeholder="Produksi, Maintenance, dll" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  onClick={() => append({ materialId: "", locationId: "", qty: 0, uomId: "", note: "" })}
                >
